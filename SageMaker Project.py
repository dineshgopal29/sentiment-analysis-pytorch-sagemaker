...
print('After cleaning and stemming the data')
...
def build_dict(data, vocab_size = 5000):
    ...
    sorted_words = list(frequent_words.keys()) 
    print("Most Frequent Word: "+sorted_words[0])
    print("Least Frequent Word: "+sorted_words[-1])
    ...
    """
    sorted_words = collections.OrderedDict(word_count)
...
print("Top 5 Frequent Words : " + str(out))
...
#  
# ### Observations:
# Top 5 words from the datatset includes keywords like movie,film,time etc. which indicate reviews related to movies. 
#  
# ###### Most Frequent Word: movi
# ###### Least Frequent Word: unmann
...
# **Answer:**
# <code> preprocess_data </code> method is cost effective and saves processing time. It serves as a lookup table. Also we using the same vocabulary for both test and train dataset which will help us produce datasets with little to no variation.
#  
# <code> convert_and_pad_data </code> - Is useful as it helps us create similiar shaped dataset as the input which are required while using NNs
...
# **Answer:**
# 
# Our current model has a potential to perfrom better if we tune it by tweaking hyperparameters. 
# **XGBoost** is a solid algorithm for supervised learning but **RNNs** have the ability to remember values as part of the temporal loop which makes it a condusive for our sentiment analysis use case where we have to analyze the data as well as predict outcome based on a predefined vocabulary dataset. 
